...
export const Footer = () => {
    ...
    <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      Sevimli dostlarımız için en taze mamayı sunan Temizmama sayesinde kedi &amp;amp; köpek bakımı ile ilgili bilinmesi gerekenlerin hepsi bu sayfada! Okuyun, öğrenin!
    </p>

    <ul class="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Anasayfa </a>
      </li>
      ...
      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Hakkımızda </a>
      </li>

      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Barınak Bağışı </a>
      </li>

      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Aydınlatma Metni </a>
      </li>

      <li>
        <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> İletişim </a>
      </li>
    </ul>
